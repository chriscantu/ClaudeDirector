...
class TestStrategicHealthPredictor:
    ...
    def test_predictor_initialization(self, ai_model_config):
        ...
        assert predictor.config.accuracy_threshold == 0.85  # Will warn about >80% for health
    ...
    def test_health_prediction_healthy_initiative(self, ai_model_config, sample_initiative_data):
    ...
    def test_health_prediction_at_risk_initiative(self, ai_model_config, sample_initiative_data):
    ...
    def test_health_prediction_failing_initiative(self, ai_model_config, sample_initiative_data):
        ...
        urgent_recommendations = [r for r in result['recommendations'] if r.get('priority') == 'urgent']
    ...
    def test_accuracy_validation(self, ai_model_config, sample_initiative_data):
        ...
        test_data = [
            (sample_initiative_data['healthy_initiative'], {'expected_health_status': 'healthy'}),
            (sample_initiative_data['at_risk_initiative'], {'expected_health_status': 'at_risk'}),
            (sample_initiative_data['failing_initiative'], {'expected_health_status': 'failing'})
        ]
    ...
    def test_health_components_calculation(self, ai_model_config, sample_initiative_data):
        ...
        expected_components = [
            'progress_score', 'stakeholder_score', 'milestone_score',
            'budget_score', 'timeline_score', 'risk_score'
        ]
    ...
    def test_trend_analysis(self, ai_model_config, sample_initiative_data):
        ...
        assert trend_analysis['momentum'] in ['accelerating', 'steady', 'slowing', 'stalled']
    ...
    def test_stakeholder_engagement_impact(self, ai_model_config):
        ...
        low_recommendations = [r for r in result_low['recommendations'] 
    ...
    def test_risk_indicator_weights(self, ai_model_config):
        ...
        high_risk_initiative['risk_indicators'] = ['budget_overrun', 'stakeholder_disengagement']
    ...
    def test_minimal_data_handling(self, ai_model_config):
        ...
        assert result['confidence'] < 0.9  # Should have lower confidence with minimal data
    ...
    def test_confidence_calculation(self, ai_model_config, sample_initiative_data):
        ...
        complete_result = predictor.predict(sample_initiative_data['healthy_initiative'])
    ...
    def test_health_status_thresholds(self, ai_model_config):
        ...
        for target_score, expected_status in test_scores:
            ...
            test_data = {
                ...
                'budget_utilization': min(0.8, target_score),  # Cap budget to avoid penalty
    ...
    def test_recommendation_prioritization(self, ai_model_config, sample_initiative_data):
        ...
        priority_indices = [priority_order.index(p) for p in priorities if p in priority_order]
    ...
    def test_backwards_compatibility(self, ai_model_config, test_database):
        ...
        with db_manager.get_connection() as conn:
            result = conn.execute("SELECT COUNT(*) FROM stakeholder_profiles_enhanced").fetchone()
            assert result[0] >= 0
