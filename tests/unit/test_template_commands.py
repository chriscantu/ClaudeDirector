...
from claudedirector.p1_features.template_commands import TemplateCommands, DEFAULT_CONFIDENCE_THRESHOLD
...
class TestTemplateCommands(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mobile_template = DirectorTemplate(
            ...
            activation_keywords=TemplateActivationKeywords(keywords={"mobile app": 0.9}),
    ...
    def test_list_templates_table_format(self):
        ...
        self.mock_engine.list_templates.return_value = [self.mobile_template, self.product_template]
    ...
    def test_list_templates_with_domain_filter(self):
        ...
        self.mock_engine.list_templates.assert_called_once_with(domain_filter="mobile_platforms")
        self.assertIn("mobile_director", result)
    ...
    def test_get_template_details_yaml_format(self):
        ...
        result = self.template_commands.get_template_details("mobile_director", format_type="yaml")
    ...
    def test_get_template_details_json_format(self):
        ...
        result = self.template_commands.get_template_details("mobile_director", format_type="json")
    ...
    def test_discover_by_context_success(self):
        ...
        self.assertIn("**Template Discovery Results for**: 'mobile app development'", result)
        self.assertIn("**1. Mobile Engineering Director** (90% match)", result)
        self.assertIn("**Domain**: mobile_platforms", result)
        self.assertIn("**Primary Personas**: marcus, sofia", result)
        self.mock_engine.discover_templates_by_context.assert_called_once_with("mobile app development", DEFAULT_CONFIDENCE_THRESHOLD)
    ...
    def test_discover_by_context_custom_threshold(self):
        ...
        self.mock_engine.discover_templates_by_context.assert_called_once_with("test context", 0.8)
    ...
    def test_validate_selection_valid(self):
        ...
        result = self.template_commands.validate_selection("mobile_director", "fintech", "startup")

        self.assertIn("✅ Template selection valid: Mobile Engineering Director", result)
        self.mock_engine.validate_template_selection.assert_called_once_with("mobile_director", "fintech", "startup")
    ...
    def test_validate_selection_with_warnings(self):
        ...
        result = self.template_commands.validate_selection("mobile_director", "unknown", None)
    ...
    def test_generate_summary_success(self):
        ...
        result = self.template_commands.generate_summary("mobile_director", "fintech", "startup")
        ...
        self.mock_engine.generate_template_summary.assert_called_once_with("mobile_director", "fintech", "startup")

    def test_generate_summary_template_not_found(self):
        """Test summary generation for non-existent template"""
        self.mock_engine.generate_template_summary.return_value = {"error": "Template not found: nonexistent"}
    ...
    def test_compare_templates_success(self):
        ...
        result = self.template_commands.compare_templates(["mobile_director", "product_engineering_director"])
        ...
        self.mock_engine.get_template_comparison.assert_called_once_with(["mobile_director", "product_engineering_director"])

    def test_compare_templates_error(self):
        """Test template comparison with error"""
        self.mock_engine.get_template_comparison.return_value = {"error": "Cannot compare more than 4 templates at once"}

        result = self.template_commands.compare_templates(["t1", "t2", "t3", "t4", "t5"])
    ...
    def test_compare_templates_no_valid_templates(self):
        ...
        result = self.template_commands.compare_templates(["nonexistent1", "nonexistent2"])
    ...
    def test_list_domains_success(self):
        ...
        self.mock_engine.get_domains.return_value = ["mobile_platforms", "product_engineering"]
    ...
    def test_default_confidence_threshold(self):
        ...
        self.mock_engine.discover_templates_by_context.assert_called_with("test context", DEFAULT_CONFIDENCE_THRESHOLD)
...
class TestTemplateCommandsIntegration(unittest.TestCase):
    ...
    def test_default_engine_creation(self):
        ...
        with patch('claudedirector.p1_features.template_commands.TemplateDiscoveryEngine') as mock_engine_class:
            mock_instance = Mock()
