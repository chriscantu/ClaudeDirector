...
async def demo_phase7_capabilities():
    ...
    if result.success:
        ...
        with open('phase7_martin_architecture_health.html', 'w') as f:
            f.write(result.html_output)
        print(f"   💾 Saved: phase7_martin_architecture_health.html")
    else:
    ...
    if result.success:
        ...
        with open('phase7_martin_service_performance.html', 'w') as f:
            f.write(result.html_output)
        print(f"   💾 Saved: phase7_martin_service_performance.html")
    ...
    if result.success:
        ...
        with open('phase7_martin_technical_debt.html', 'w') as f:
            f.write(result.html_output)
        print(f"   💾 Saved: phase7_martin_technical_debt.html")
    ...
    if result.success:
        ...
        with open('phase7_rachel_component_adoption.html', 'w') as f:
            f.write(result.html_output)
        print(f"   💾 Saved: phase7_rachel_component_adoption.html")
    ...
    if result.success:
        ...
        with open('phase7_rachel_maturity.html', 'w') as f:
            f.write(result.html_output)
        print(f"   💾 Saved: phase7_rachel_maturity.html")
    ...
    if result.success:
        ...
        with open('phase7_rachel_design_debt.html', 'w') as f:
            f.write(result.html_output)
        print(f"   💾 Saved: phase7_rachel_design_debt.html")
