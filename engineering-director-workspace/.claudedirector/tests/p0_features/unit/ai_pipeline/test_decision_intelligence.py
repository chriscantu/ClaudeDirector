...
class TestDecisionIntelligenceEngine:
    ...
    def test_decision_detection_no_decisions(self, ai_model_config, sample_meeting_content):
    ...
    def test_accuracy_validation(self, ai_model_config):
        ...
        test_data = [
            ...
            ("DECISION 1: Use React. DECISION 2: Deploy Friday", {'expected_decisions': 2})
        ]
    ...
    def test_confidence_scoring(self, ai_model_config):
        ...
        low_confidence_text = "Maybe we should consider doing something about the performance issues."
        
        high_result = engine.predict(high_confidence_text)
        low_result = engine.predict(low_confidence_text)
        
        if high_result['decisions_detected'] > 0 and low_result['decisions_detected'] > 0:
    ...
    def test_duplicate_decision_removal(self, ai_model_config):
        ...
        assert result['decisions_detected'] <= 2  # Should not detect 3 separate decisions
    ...
    def test_model_retraining_trigger(self, ai_model_config):
        ...
        with patch.object(engine, 'logger') as mock_logger:
            ...
            engine.record_query_performance("test", 300, 1, 0.70)  # Exceeds time SLA and accuracy
    ...
    def test_configuration_validation(self):
        ...
        config = AIModelConfig(
            model_name="test",
            accuracy_threshold=0.60  # Below recommended 85%
        )
