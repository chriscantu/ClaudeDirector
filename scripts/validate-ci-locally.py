...
def flake8_linting():
    ...
    result = run_command("python -m flake8 .claudedirector/ --max-line-length=120 --extend-ignore=E203,W503,E501,F541,F841,E302,E303,E305,E402,E261,E128,E129,E722,E731,F824,F811,W292,F821,E712 --statistics")
    if result.returncode == 0:
...
def unit_tests_with_coverage():
    ...
    result = run_command("python -m coverage run --source=.claudedirector/lib .claudedirector/tests/unit/test_coverage_simple_direct.py")
    if result.returncode != 0:
