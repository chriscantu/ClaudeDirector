...
class TestZeroSetupValidation:
    ...
    def test_error_message_clarity(self):
        ...
        error_scenarios = [
            ("mcp_unavailable", "MCP enhancement unavailable, using standard analysis"),
    ...
    def _generate_user_friendly_error(self, scenario_type):
        ...
        error_messages = {
            "mcp_unavailable": "The strategic analysis framework is temporarily unavailable, so I'll provide guidance based on my core knowledge.",
