...
class TestStakeholderDetectionPerformance:
    ...
    def test_stakeholder_detection_response_time(self, mock_engagement, mock_detector, mock_ai):
        ...
        def benchmark_detection():
            return stakeholder_intel.detect_stakeholders_in_content(self.small_text, {"source": "benchmark"})
        ...
        def benchmark_medium():
            return stakeholder_intel.detect_stakeholders_in_content(self.medium_text, {"source": "benchmark"})
        ...
        def benchmark_large():
            return stakeholder_intel.detect_stakeholders_in_content(self.large_text, {"source": "benchmark"})
        ...
        assert small_stats['avg_time'] < 0.1, f"Small text detection too slow: {small_stats['avg_time']}s"
        assert medium_stats['avg_time'] < 0.5, f"Medium text detection too slow: {medium_stats['avg_time']}s"
        assert large_stats['avg_time'] < 2.0, f"Large text detection too slow: {large_stats['avg_time']}s"
    ...
    @patch('claudedirector.intelligence.stakeholder.IntelligentStakeholderDetector')
    @patch('claudedirector.intelligence.stakeholder.StakeholderEngagementEngine')
    def test_stakeholder_detection_memory_usage(self, mock_engagement, mock_detector, mock_ai):
        ...
        _, small_memory = self.measure_memory(
            stakeholder_intel.detect_stakeholders,
            self.small_text
        )
        ...
        assert medium_memory < 20, f"Medium text uses too much memory: {medium_memory}MB"
