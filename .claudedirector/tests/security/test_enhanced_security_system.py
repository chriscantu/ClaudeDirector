...
class TestEnhancedSecuritySystem(unittest.TestCase):
    ...
    def test_stakeholder_pattern_detection(self):
        ...
        self.assertGreater(len(violations), 0, "Scanner should detect stakeholder threats")

        # Check for critical severity
        critical_violations = [v for v in violations if v['severity'] == 'CRITICAL']
        self.assertGreater(len(critical_violations), 0, "Should detect critical violations")
    ...
    def test_strategic_intelligence_detection(self):
        ...
        self.assertGreater(len(violations), 0, "Scanner should detect strategic intelligence")
    ...
    def test_comprehensive_scan_scoring(self):
        ...
        self.assertEqual(scan_report['security_score'], 100, "Clean file should have perfect score")
        self.assertEqual(scan_report['threats_detected'], 0, "Clean file should have no threats")
    ...
    def test_continuous_monitor_dashboard_data(self):
        ...
        required_fields = ['timestamp', 'status', 'security_posture', 'alerts_24h', 'system_health']
    ...
    def test_verifiable_proof_generation(self):
        ...
        expected_types = ['SYSTEMATIC_VALIDATION', 'UNBYPASSABLE_ARCHITECTURE', 'CONTINUOUS_MONITORING']

        for expected_type in expected_types:
            self.assertIn(expected_type, proof_types, f"Should include {expected_type} proof")
    ...
    def test_scanner_self_exclusion(self):
        ...
        self.assertEqual(len(violations), 0, "Security files should be excluded from scanning")

    def test_threat_pattern_comprehensiveness(self):
        """Test that threat patterns are comprehensive"""
        # Check stakeholder patterns
        self.assertGreater(len(self.scanner.stakeholder_patterns), 5,
                          "Should have comprehensive stakeholder patterns")

        # Check strategic intelligence patterns
        self.assertGreater(len(self.scanner.strategic_intelligence_patterns), 5,
        ...
        self.assertGreater(len(stakeholder_pattern_text), 200,
