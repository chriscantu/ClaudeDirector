...
class TestTaskAIDetection(unittest.TestCase):
    ...
    def test_task_confidence_thresholds(self, mock_manager, mock_detector):
        ...
        self.assertTrue(0.90 >= high_confidence_threshold, "High confidence should exceed auto-create threshold")
        self.assertTrue(0.70 >= review_threshold, "Medium confidence should exceed review threshold")
        self.assertFalse(0.45 >= review_threshold, "Low confidence should be below review threshold")
