...
from lib.claudedirector.p0_features.shared.ai_pipeline.ai_base import AIModelConfig, AIEngineBase
from lib.claudedirector.p0_features.shared.database_manager.db_base import DatabaseConfig, QueryContext
...
def sample_initiative_data():
    ...
    return {
        ...
        'at_risk_initiative': {
            ...
            'risk_indicators': ['scope_creep', 'resource_constraints', 'stakeholder_disengagement'],
        ...
        'failing_initiative': {
            ...
            'risk_indicators': ['major_delays', 'budget_overrun', 'technical_blockers', 'stakeholder_disengagement'],
    ...
    class MockHealthPredictor:
        ...
        def predict(self, initiative_data: Dict[str, Any]) -> Dict[str, Any]:
            ...
            return {
                ...
                'recommendations': [
                    'Increase stakeholder engagement' if stakeholder_score < 0.7 else None,
