...
class TestContextSwitching(unittest.TestCase):
        ...
        self.context_scenarios = {
            "strategic_to_technical": {
                "initial_context": {
                    ...
                    "persona": "camille",
                    "discussion_points": ["team_structure", "hiring_strategy", "leadership_development"]
                },
                "switch_to": {
                    "topic": "platform_architecture",
                    "persona": "martin",
                    "discussion_points": ["microservices", "database_design", "performance_optimization"]
                },
            ...
            "technical_to_business": {
                "initial_context": {
                    "topic": "platform_architecture",
                    "persona": "martin",
                    "discussion_points": ["system_design", "scalability", "technical_debt"]
                },
                "switch_to": {
                    "topic": "investment_analysis",
                    "persona": "alvaro",
                    "discussion_points": ["roi_calculation", "budget_allocation", "business_justification"]
                },
            ...
            "business_to_design": {
                "initial_context": {
                    "topic": "investment_analysis",
                    "persona": "alvaro",
                    "discussion_points": ["platform_roi", "competitive_advantage", "market_positioning"]
                },
                "switch_to": {
                    "topic": "user_experience",
                    "persona": "rachel",
                    "discussion_points": ["design_systems", "user_adoption", "accessibility"]
                },
    ...
    def test_persona_handoff_continuity(self):
        ...
        handoff_scenarios = [
            {
                ...
                "context_to_preserve": ["organizational_goals", "strategic_constraints", "timeline_requirements"]
            },
            {
                ...
                "context_to_preserve": ["business_objectives", "roi_requirements", "competitive_positioning"]
            },
            {
                ...
                "context_to_preserve": ["user_requirements", "design_constraints", "accessibility_needs"]
            }
        ]
        ...
        for scenario in handoff_scenarios:
            ...
            initial_context = self._simulate_persona_context_establishment(
                scenario["initial_persona"],
                scenario["context_to_preserve"]
            )
    ...
    def test_multi_thread_conversation_management(self):
        ...
        conversation_threads = [
            {
                ...
                "key_points": ["team_structure", "technical_architecture", "implementation_timeline"],
                "priority": "high"
            },
            {
                ...
                "key_points": ["roi_analysis", "competitive_positioning", "executive_approval"],
                "priority": "medium"
            },
            {
                ...
                "key_points": ["design_system_adoption", "user_feedback", "team_coordination"],
                "priority": "low"
            }
        ]
        ...
        thread_switches = [
            {"from": "thread_001", "to": "thread_002", "switch_reason": "urgent_budget_question"},
            {"from": "thread_002", "to": "thread_003", "switch_reason": "user_feedback_received"},
            {"from": "thread_003", "to": "thread_001", "switch_reason": "return_to_primary_discussion"}
        ]
        ...
        deep_context_scenarios = [
            {
                ...
                "context_layers": {
                    ...
                    "intermediate": ["stakeholder_concerns", "change_resistance", "communication_strategy"],
                    "deep": ["cultural_implications", "individual_motivations", "long_term_organizational_health"]
                },
            ...
            },
            {
                ...
                "context_layers": {
                    ...
                    "intermediate": ["competitive_analysis", "risk_assessment", "resource_allocation"],
                    "deep": ["strategic_positioning", "market_timing", "organizational_capability_building"]
                },
        ...
        temporal_scenarios = [
            {
                ...
                "timeline": [
                    {"phase": "planning", "duration": "2_weeks", "dependencies": [], "key_decisions": ["architecture_choice", "team_allocation"]},
                    {"phase": "development", "duration": "8_weeks", "dependencies": ["planning"], "key_decisions": ["technology_stack", "integration_approach"]},
                    {"phase": "rollout", "duration": "4_weeks", "dependencies": ["development"], "key_decisions": ["deployment_strategy", "user_training"]}
                ],
                "current_phase": "development",
                "temporal_context": ["planning_decisions_made", "development_in_progress", "rollout_approaching"]
            },
            {
                "scenario": "quarterly_strategic_review",
                "timeline": [
                    {"phase": "q1_execution", "duration": "3_months", "dependencies": [], "key_decisions": ["initiative_prioritization", "resource_allocation"]},
                    {"phase": "q2_planning", "duration": "1_month", "dependencies": ["q1_execution"], "key_decisions": ["strategy_adjustment", "new_initiatives"]},
                    {"phase": "q2_execution", "duration": "3_months", "dependencies": ["q2_planning"], "key_decisions": ["execution_optimization", "performance_monitoring"]}
                ],
                "current_phase": "q2_planning",
                "temporal_context": ["q1_results_available", "q2_planning_active", "q2_execution_upcoming"]
            }
        ]
    ...
    def _simulate_context_switch(self, initial_session, new_topic, new_persona, new_discussion_points):
        ...
        return {
            ...
            "bridge_content": self._generate_context_bridge(initial_session["topic"], new_topic) if "bridge" in transition_quality else ""
        }
    ...
    def _simulate_persona_handoff(self, initial_context, target_persona, handoff_trigger):
    ...
    def _simulate_temporal_context_establishment(self, scenario, timeline, current_phase):
    ...
    def _simulate_temporal_context_switch(self, temporal_session, new_question_type):
        ...
        return {
            ...
            "dependency_awareness": {phase["phase"]: phase["dependencies"] for phase in temporal_session["timeline"]},
            "temporal_reasoning_active": True
        }

    def _calculate_transition_quality(self, old_topic, new_topic, old_persona, new_persona):
        ...
        persona_compatibility = self._calculate_persona_compatibility(old_persona, new_persona)
