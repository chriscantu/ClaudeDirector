...
class TestConfigurationPersistence(unittest.TestCase):
    ...
    def test_user_configuration_persistence(self):
        ...
        # Verify persistence
        self.assertTrue(self.user_config_file.exists(),
                       "User configuration file must be created")
    ...
    def test_persona_preferences_persistence(self):
        ...
        # Verify persistence
        self.assertTrue(self.persona_config_file.exists(),
        ...
        self.assertEqual(loaded_preferences["diego"]["communication_style"], "direct_challenging")
        self.assertEqual(loaded_preferences["camille"]["framework_preference"], "Good Strategy Bad Strategy")
        self.assertEqual(loaded_preferences["alvaro"]["roi_minimum"], 1.15)
        self.assertTrue(loaded_preferences["rachel"]["accessibility_priority"] == "high")
    ...
    def test_workspace_settings_persistence(self):
        ...
        # Verify persistence
        self.assertTrue(self.workspace_config_file.exists(),
        ...
        self.assertEqual(loaded_settings["current_workspace"], "/Users/executive/strategic-projects")
        self.assertIn("platform-scaling", loaded_settings["project_contexts"])
        self.assertIn("NGX Gold", loaded_settings["project_contexts"]["platform-scaling"]["initiatives"])
    ...
    def test_configuration_backup_and_recovery(self):
        ...
        original_config = {
            ...
            "strategic_context": {
                ...
                "decision_history": [
                    {"decision": "NGX Gold Investment", "outcome": "approved", "roi": 1.21}
                ]
            },
            "backup_metadata": {
                "created_at": datetime.now().isoformat(),
        ...
        # Verify corruption
        self.assertEqual(os.path.getsize(config_file), 0, "Config file should be corrupted (empty)")
        ...
        self.assertIn("Platform Scaling", recovered_config["strategic_context"]["current_initiatives"])
        self.assertEqual(recovered_config["strategic_context"]["stakeholder_relationships"]["hemendra"], "platform_opponent")
    ...
    def test_cross_session_persistence(self):
        ...
        self.assertTrue(session_file.exists(), "Session file must persist after restart")
        ...
        self.assertEqual(session2_config["user_preferences"]["default_persona"], "diego")
        self.assertEqual(session2_config["active_contexts"]["current_project"], "platform_transformation")
        ...
        self.assertEqual(final_config["user_preferences"]["analysis_mode"], "executive_summary")
