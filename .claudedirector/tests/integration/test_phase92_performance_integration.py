...
def test_strategic_performance_manager_integration():
    ...
    try:
        ...
        from performance.strategic_performance_manager import (
            StrategicPerformanceManager, QueryType, QueryPerformanceResult
        )
        ...
        print(f"✅ Memory monitoring working - Current: {memory_report['current_mb']:.1f}MB")
        ...
        print(f"✅ Memory optimization working - Saved: {optimization_result['memory_saved_mb']:.1f}MB")
...
async def test_strategic_query_performance():
    ...
    try:
        from performance.strategic_performance_manager import (
            StrategicPerformanceManager, QueryType
        )
        from core.base_manager import BaseManagerConfig, ManagerType
        ...
        query_result2, performance_result2 = await performance_manager.optimize_strategic_query(
            mock_strategic_query,
            QueryType.STRATEGIC_STANDARD,
