...
class TestDocumentationFunctionalityPreservation(unittest.TestCase):
    ...
    def test_technical_documentation_structure(self):
        ...
        # Phase 3-4 docs have been archived to docs/archive/completed-phases/
        key_docs = [
            "docs/architecture/OVERVIEW.md",
            "docs/architecture/PROJECT_STRUCTURE.md",
            "docs/architecture/TESTING_ARCHITECTURE.md",
            "docs/archive/completed-phases/PHASE3_IMPLEMENTATION_PLAN.md",
            "docs/archive/completed-phases/PHASE3_TECHNICAL_STORIES.md",
        ]
