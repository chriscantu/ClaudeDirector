...
class ConversationalDataManager:
    ...
    async def parse_conversational_query(self, query_text: str, context: Dict[str, Any] = None) -> ConversationalQuery:
        """
    ...
    async def _fetch_team_performance(self, query: ConversationalQuery) -> Dict[str, Any]:
    ...
    async def _fetch_architecture_health(self, query: ConversationalQuery) -> Dict[str, Any]:
        """Fetch architecture health metrics"""
        return {
            "system": query.entities[0] if query.entities else "Platform Services",
            "health_score": 0.92,
            "services": {
                "api_gateway": {"status": "healthy", "response_time": 45, "uptime": 0.999},
                "user_service": {"status": "healthy", "response_time": 32, "uptime": 0.998},
                "data_service": {"status": "warning", "response_time": 78, "uptime": 0.995}
            },
            "metrics": {
    ...
    async def _fetch_design_system_status(self, query: ConversationalQuery) -> Dict[str, Any]:
    ...
    async def _fetch_github_activity(self, query: ConversationalQuery) -> Dict[str, Any]:
    ...
    async def _fetch_general_analytics(self, query: ConversationalQuery) -> Dict[str, Any]:
    ...
    async def process_conversational_query(self, query_text: str, context: Dict[str, Any] = None) -> Tuple[ConversationalQuery, DataResponse]:
        """
