...
from .executive_visualization_server import ExecutiveVisualizationEngine, VisualizationResult
...
class IntegratedVisualizationWorkflow:
        ...
        try:
            ...
            if not analysis_result.success:
                return IntegratedWorkflowResult(
                    ...
                    visualization_result=VisualizationResult(
                        success=False, html_output="", chart_type="", persona=persona,
                        generation_time=0, file_size_bytes=0, interactive_elements=[],
            ...
            logger.info(f"Step 3: Generating executive visualization - {visualization_spec.get('chart_type', 'default')}")
            ...
            self._update_workflow_metrics(total_workflow_time, analysis_result.success, visualization_result.success)
            ...
            return IntegratedWorkflowResult(
                ...
                analysis_result=ExecutionResult(
                    ...
                    memory_usage=0, persona_context=persona
                ),
                visualization_result=VisualizationResult(
                    success=False, html_output="", chart_type="", persona=persona,
                    generation_time=0, file_size_bytes=0, interactive_elements=[],
    ...
    def _create_leadership_sample_data(self, analysis_output: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "analysis_source": analysis_output[:200] + "..." if len(analysis_output) > 200 else analysis_output
        }
...
"""
    ...
    def _update_workflow_metrics(self, workflow_time: float, analysis_success: bool, viz_success: bool):
    ...
    def _generate_persona_analysis_code(self, query: str, persona: str, context: Dict[str, Any]) -> str:
