    ...
    def generate_recommendations(
        ...
        try:
            ...
            logger.info(
                ...
                high_priority=len(
                    [r for r in prioritized_recommendations if r.priority == self.config.get_enum_values('priority_levels')[1]]
                ),
            )
    ...
    def _generate_category_recommendations(
        ...
        recommendation_templates = {
            "current_state": {
                ...
                "priority": self.config.get_enum_values('priority_levels')[1] if avg_confidence > 0.7 else self.config.get_enum_values('priority_levels')[2],
                "implementation_effort": self.config.get_enum_values('priority_levels')[2],
                "expected_impact": self.config.get_enum_values('priority_levels')[1] if avg_confidence > 0.7 else self.config.get_enum_values('priority_levels')[2],
            },
            "stakeholder_mapping": {
