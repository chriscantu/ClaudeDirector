...
class DatabaseError(ClaudeDirectorError):
    ...
    def __init__(
        self, message: str, db_path: Optional[str] = None, **kwargs: Any
    ) -> None:
...
class ConfigurationError(ClaudeDirectorError):
    ...
    def __init__(
        ...
        super().__init__(
            message, component="configuration", config_key=config_key, **kwargs
        )
...
class WorkspaceError(ClaudeDirectorError):
    ...
    def __init__(
        self, message: str, workspace_path: Optional[str] = None, **kwargs: Any
    ) -> None:
        self.workspace_path = workspace_path
        super().__init__(
            message, component="workspace", workspace_path=workspace_path, **kwargs
        )
...
class SetupError(ClaudeDirectorError):
    ...
    def __init__(
        self, message: str, setup_component: Optional[str] = None, **kwargs: Any
    ) -> None:
        self.setup_component = setup_component
        super().__init__(
            message, component="setup", setup_component=setup_component, **kwargs
        )
