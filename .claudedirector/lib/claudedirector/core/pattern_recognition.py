...
class PatternRecognitionEngine:
    ...
    def __init__(self, workspace_path: str):
        ...
        self.patterns_db = (
            self.workspace_path / ".claudedirector" / "workflow_patterns.json"
        )
        self.templates_db = (
            self.workspace_path / ".claudedirector" / "template_recommendations.json"
        )
    ...
    def analyze_user_patterns(
        ...
        high_confidence_patterns = [
            p for p in all_patterns if p.confidence >= self.min_confidence_threshold
        ]
    ...
    def _analyze_content_sequences(
        self, session_data: List[Dict[str, Any]]
    ) -> List[WorkflowPattern]:
    ...
    def _create_template_recommendation(
    ...
    def update_patterns_from_usage(self, session_data: List[Dict[str, Any]]) -> None:
        ...
        new_recommendations = self.generate_template_recommendations(
    ...
    def get_pattern_insights(self) -> Dict[str, Any]:
        ...
        insights = {
            ...
            "high_confidence_patterns": len(
                [p for p in self.workflow_patterns if p.confidence > 0.8]
            ),
        ...
        top_patterns = sorted(
            self.workflow_patterns, key=lambda x: x.confidence, reverse=True
        )[:5]
