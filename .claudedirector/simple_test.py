...
def test_schema_creation():
    ...
    schema_path = os.path.join(
        current_dir, "config", "schemas", "session_context_schema.sql"
    )
...
def test_basic_session_operations():
    ...
    try:
        ...
        if row:
            ...
            print(
                f"✅ Context retrieved: {len(stakeholder_context)} stakeholders, {len(initiative_context)} initiatives"
            )
...
def test_procore_context_simulation():
    """Test with actual Procore stakeholder context"""
    print("🧪 Testing Procore context simulation...")
    ...
    try:
        ...
        # Store Procore stakeholder context
        ...
        print(f"❌ Procore context simulation failed: {e}")
        return False
...
def main():
    ...
    tests = [
        ...
        ("Procore Context Simulation", test_procore_context_simulation),
    ]
