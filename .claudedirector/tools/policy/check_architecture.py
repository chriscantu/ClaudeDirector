...
def main():
    ...
    if total_violations:
        ...
        print("- Reference docs/development/guides/CORE_ARCHITECTURE.md for architectural principles")
        print("- Follow docs/development/guides/DEVELOPMENT_WORKFLOW.md for import standards")
        print()
