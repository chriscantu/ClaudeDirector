...
How should we approach this systematically?""",
        ...
        for test_case in test_cases:
            print_test_case(test_case["name"], test_case["input"], test_case["expected"])
    ...
    def test_complexity_analysis(self):
        ...
        try:
            from claudedirector.core.complexity_analyzer import ComplexityAnalyzer, ComplexityLevel
            ...
            test_cases = [
                ...
                ("How should we restructure our engineering teams for scalability while maintaining design system consistency across multiple international product teams?", ComplexityLevel.HIGH),
            ]
            ...
            for test_input, expected_level in test_cases:
                ...
                if result.complexity_level == expected_level:
                    ...
                    print(f"  ⚠ Misclassified: expected {expected_level.value}, got {result.complexity_level.value}")
    ...
    def test_transparency_engine(self):
        ...
        try:
            from claudedirector.transparency.transparency_engine import TransparencyEngine
    ...
    def print_summary(self):
        ...
        success_rate = (self.programmatic_tests_passed / total_programmatic * 100) if total_programmatic > 0 else 0
        
        print(f"📊 Programmatic Tests: {self.programmatic_tests_passed}/{total_programmatic} passed ({success_rate:.1f}%)")
...
async def main():
    ...
    print("Consolidated test suite combining manual verification and programmatic validation")
