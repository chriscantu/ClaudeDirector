...
**ClaudeDirector activates the right strategic advisor AND framework based on your conversation:**
...
```
👤 "I need to have a difficult conversation with the executive about platform investment ROI"
🤖 Alvaro + Crucial Conversations: "Let's apply the seven-step approach...
...
```
👤 "How should we structure our engineering teams for optimal platform delivery?"
🤖 Diego + Team Topologies: "Let's assess team types and interaction patterns...
   🏗️ TEAM TYPES: Stream-aligned for domains, Platform for shared services
   🧠 COGNITIVE LOAD: 5-9 people optimal, clear boundaries and responsibilities
   🔗 INTERACTION MODES: X-as-a-Service for platforms, Collaboration for discovery..."
```

### **📚 Embedded Strategic Frameworks**

**ClaudeDirector automatically applies the right methodology from 11 proven frameworks:**
...
#### **🏗️ Organization & Teams**
- **Organizational Transformation** → Change management and capability development
- **"Team Topologies" (Skelton & Pais)** → Team structure and Conway's Law alignment
- **"Accelerate" (Forsgren, Humble, Kim)** → Team performance and DORA metrics

#### **🤝 Stakeholder & Communication**
- **"Crucial Conversations" (Patterson, Grenny, McMillan, Switzler)** → Executive communication and dialogue
...
**[📖 Strategic Frameworks Guide](STRATEGIC_FRAMEWORKS_GUIDE.md)** - Complete reference for all 11 frameworks:
- Rumelt Strategy Kernel methodology and fluff detection
- Heath Brothers WRAP decision framework and systematic decision-making
- Team Topologies for organizational structure and Conway's Law alignment
- Accelerate framework for team performance and DORA metrics
- Crucial Conversations for stakeholder management and executive communication
- Capital Allocation for technology investment and resource optimization
- Strategic Platform Assessment approach and comprehensive planning
...
# Find the best strategic advisor for your specific need
...
- **Be specific**: "iOS memory leaks" gets better strategic advisor selection than "app issues"
- **Use context**: Mention your industry ("fintech", "healthcare") for specialized guidance

### Confidence Levels
- **High confidence (>80%)**: Strategic advisor activates immediately
...
**That's it!** Your AI strategic advisor team is ready. Just start talking about your engineering challenges and watch the right expertise activate automatically.

**Next**: Explore the complete strategic framework documentation to understand all customization options.
