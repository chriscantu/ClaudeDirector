...
from ..core.template_engine import TemplateDiscoveryEngine, TemplateValidationError
from ..utils.formatting import (
    format_success,
    format_warning,
    format_error,
    format_status_indicator_indicator,
    format_progress_bar,
    format_table,
    format_list,
)
    ...
    def _validate_template_config(
        ...
        for field in required_fields:
            if field not in config:
                errors.append(f"Template {template_id} missing required field: {field}")
