...
JIRA_BASE_URL="${JIRA_BASE_URL:-https://***REMOVED***}"
...
echo "📊 Fetching completed epics from ***REMOVED*** Jira (since ${SEVEN_DAYS_AGO})..."
...
Context: You are operating as Director of Engineering for UI Foundation Platform at ***REMOVED***, using your SuperClaude strategic leadership framework.
